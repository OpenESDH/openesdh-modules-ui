    ...
    function ProjectRoomsInviteController($state, $stateParams, projectRoomsService, $translate, notificationUtilsService){
        ...
        function init(){
            if($stateParams.action === 'reject'){
                projectRoomsService.getInvitationByTicket($stateParams.inviteId, $stateParams.ticket).then(function(invite){
                    vm.invite = invite;
                    vm.reject = true
                });
        ...
        function rejectInvite(){
            projectRoomsService.rejectInvite($stateParams.inviteId, $stateParams.ticket).then(function(response){
                vm.reject = false;
        ...
        function acceptInvite(){
            projectRoomsService.acceptInvite($stateParams.inviteId, $stateParams.ticket).then(function(response){
                vm.reject = false;
